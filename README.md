...
4.数理逻辑第一章作业：《图论与代数结构（第2版）》《数理逻辑与集合论（第2版）》P12: 1(2,4,6,8), 4(2,4,6), 5(2,4,6,8), 6(2)。截止时间：4月27日  
5.数理逻辑第二章作业：《图论与代数结构（第2版）》《数理逻辑与集合论（第2版）》P37: 1(1,3), 2, 3, 4(2), 5(8), 7(10,11), 8(4,5,6), 9(1), 12(1)。截止时间：4月27日  
